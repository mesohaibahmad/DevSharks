...
export default function Services({category, data}){
    ...
    <ServiceCard image={data.img2} userName={data.nm2} profilePic={"/images/wordpress website.png"} description={data.desc} price={2500} onclick={'http://localhost:5173/UserService'}/>,
